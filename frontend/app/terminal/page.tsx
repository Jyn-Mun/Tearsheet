  ...
  return (
    <div className="app">
      ...
      <main className="main">
        ...
        <Interpretation ticker={ticker} index={1} mode={mode} />
        <MoveExplain ticker={ticker} index={2} mode={mode} />
        <Analysis ticker={ticker} index={3} mode={mode} />
        <Dcf ticker={ticker} index={4} mode={mode} />
        <Valuation ticker={ticker} index={5} mode={mode} />
        <Events ticker={ticker} index={6} mode={mode} />
        <Financials ticker={ticker} index={7} mode={mode} />
        <News ticker={ticker} index={8} mode={mode} />

        <div className="footer">
          Generated by AI from public sources · research tool, not financial advice · no buy/sell/hold, no price target<br />
          {mode === "live" ? "Live data via Financial Modeling Prep (free tier — limited)." : "Offline snapshot data."} · provenance traced per figure · {new Date().getUTCFullYear()} · Tearsheet
        </div>
      </main>
    </div>
  );
